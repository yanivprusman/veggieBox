...
// Shared data models — mirror the JSON from the veggieBox Next.js backend (camelCase).
// @Serializable so they work with kotlinx-serialization on Android AND iOS.
// (The Android app currently deserializes via Retrofit/Gson, which ignores the
// annotation; iOS will use kotlinx-serialization with the same classes.)
